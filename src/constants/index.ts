...
export const SERVICES = [
  ...
  },
  {
    ...
    description: "Dominate search rankings with our proven SEO strategies. We combine technical optimization, quality content, and authoritative link building to drive consistent organic traffic.",
